...
/*
     ...
     {ID= 101,Name = "Preety", Salary = 10000, Department = "IT"},
     {ID= 104,Name = "Hina", Salary = 20000, Department = "IT"},
     {ID= 105,Name = "Anurag", Salary = 30000, Department = "IT"},
     {ID= 106,Name = "Sara", Salary = 25000, Department = "IT"},
     {ID= 107,Name = "Pranaya", Salary = 35000, Department = "IT"},

     {ID= 102,Name = "Priyanka", Salary = 15000, Department = "Sales"},
     {ID= 103,Name = "James", Salary = 50000, Department = "Sales"},
     {ID= 108,Name = "Manoj", Salary = 11000, Department = "Sales"},
     {ID= 109,Name = "Sam", Salary = 45000, Department = "Sales"},
     {ID= 110,Name = "Saurav", Salary = 25000, Department = "Sales"}
